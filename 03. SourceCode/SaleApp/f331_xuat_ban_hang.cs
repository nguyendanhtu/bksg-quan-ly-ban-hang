...
namespace SaleApp
{
    public partial class f331_xuat_ban_hang : Form
    {
        ...
        private void print()
        {
            ...
            //Tao cac doi tuong application, document, table cua MS Word
            Microsoft.Office.Interop.Word.Application app = new Microsoft.Office.Interop.Word.Application();
            Microsoft.Office.Interop.Word.Document doc;
            Microsoft.Office.Interop.Word.Table table;
            // Mo word
            app.Visible = true;
            //Tham so truyen vao la tuy chon
            ...
            table = doc.Tables.Add(range, m_fg.Rows.Count, 4, ref obj, ref obj);
            //xuat du lieu ra word

            //tim so rows cua grid
           
         

            for (int i = 0; i < m_fg.Rows.Count-1; i++)
                  {

                        doc.Tables[1].Rows[i + 1].Cells[1].Range.Text = m_fg.Rows[i][2].ToString();
                        doc.Tables[1].Rows[i + 1].Cells[2].Range.Text = m_fg.Rows[i][4].ToString();
                        doc.Tables[1].Rows[i + 1].Cells[3].Range.Text = m_fg.Rows[i][3].ToString();
                        doc.Tables[1].Rows[i + 1].Cells[4].Range.Text = m_fg.Rows[i][5].ToString();

                        
                    }
            doc.Tables[1].Rows[m_fg.Rows.Count].Cells[3].Range.Text = "Tổng tiền:";
            doc.Tables[1].Rows[m_fg.Rows.Count].Cells[4].Range.Text = m_txt_total_price.Text;
                    doc.Select();
                    ...
                    Microsoft.Office.Interop.Word.WdPaperSize pagesize = Microsoft.Office.Interop.Word.WdPaperSize.wdPaperCustom;
        ...
        private void set_define_event()
        {
            ...
            this.m_cmd_print.Click+=new EventHandler(m_cmd_print_Click);
