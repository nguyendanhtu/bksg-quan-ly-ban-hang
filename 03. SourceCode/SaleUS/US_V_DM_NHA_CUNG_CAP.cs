...
/// Date: 14/07/2013 07:02:24
/// Goal: Create User Service Class for V_DM_NHA_CUNG_CAP
///************************************************
/// <summary>
/// Create User Service Class for V_DM_NHA_CUNG_CAP
/// </summary>
...
public class US_V_DM_NHA_CUNG_CAP : US_Object
{
	private const string c_TableName = "V_DM_NHA_CUNG_CAP";
...
#region "Init Functions"
	public US_V_DM_NHA_CUNG_CAP() 
	{
		pm_objDS = new DS_V_DM_NHA_CUNG_CAP();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_DM_NHA_CUNG_CAP(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_DM_NHA_CUNG_CAP(decimal i_dbID) 
	{
		pm_objDS = new DS_V_DM_NHA_CUNG_CAP();
		pm_strTableName = c_TableName;
